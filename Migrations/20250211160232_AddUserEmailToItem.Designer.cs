...
namespace ShoppingCartApp.Migrations
{
    ...
    [Migration("20250211160232_AddUserEmailToItem")]
    partial class AddUserEmailToItem
    {
        /// <inheritdoc />
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            // Disable Foreign Key checks before modifying tables
            modelBuilder.HasAnnotation("Sql", "PRAGMA foreign_keys = OFF;");
            ...
            modelBuilder.HasAnnotation("Sql", "PRAGMA foreign_keys = ON;");
